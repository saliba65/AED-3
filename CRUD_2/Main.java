...
public class Main {
  ...
  private static CRUD2<Book> arqLivros;
  private static CRUD2<Client> arqCliente;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      arqLivros = new CRUD2<>(Book.class.getConstructor(), "livros.db");
      ...
      System.out.println(arqLivros.read("Número Zero"));
      ...
      l1.autor = "I. Asimov";
      arqLivros.update(l1);
      System.out.println(arqLivros.read("Eu, Robô"));
    ...
    try {
      ...
      arqCliente = new CRUD2<>(Client.class.getConstructor(), "clients.db");
